...
const BOOK_NAME_RE =
  /\b(spell\s*books?|spellbook|books?|tome|journal|diary|codex|grimoire|lexicon|folio|primer|treatise|chapbook|ledger|parchment|paper|spell\s*scroll|scroll\s*case|maps?|ink\s*pen|quill|hymnal|bestiary|chronicle|compendium|almanac|atlas|catalogue|catalog)\b/i;
